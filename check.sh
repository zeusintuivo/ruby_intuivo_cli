...
SPRING_PID=0
kill_spring(){
    RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec  spring stop
    wait
...
start_spring(){
  SPRING_PID=$(RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec  spring server&)
}
interrupt_rspec() {
...
${PURPLE_BLUE}  + ${YELLOW220}\"${ONE_FILE}\""
    ...
    if command -v rspec >/dev/null 2>&1; then
      ...
      {
        echo -e "${PURPLE_BLUE}  + ${CYAN}CI_RSPEC=true RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec rspec --format progress --format RspecJunitFormatter --out rspec.xml ${YELLOW220}${INTEGRATION_TESTS_EXISTS}${RESET}"
    ...
    echo -e "${PURPLE_BLUE}  + ${CYAN}RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec ruby -I\"lib:test\" -I${RAKE_EXECUTABLE} ${YELLOW220}${INTEGRATION_TESTS_EXISTS}${RESET}"
    eval "RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec ruby -I\"lib:test\" -I${RAKE_EXECUTABLE} " ${INTEGRATION_TESTS_EXISTS}
    echo -e "${PURPLE_BLUE}  + ${RESET}"
    echo -e "${PURPLE_BLUE}  + ${RESET}"
...
${PURPLE_BLUE}  + ${YELLOW220}'${ONE_FILE}'"
    ...
    if [[ -n "${CUCUMBER_TESTS_EXISTS}" ]] ; then
    {
      ...
      echo -e "${PURPLE_BLUE}  + "
      echo -e "${PURPLE_BLUE}  + "
      echo -e "${PURPLE_BLUE}  + ${CYAN}RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec cucumber ${YELLOW220}${CUCUMBER_TESTS_EXISTS}${RED}"
      echo -e "${PURPLE_BLUE}  + ${RESET}"
      eval "RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec cucumber ${CUCUMBER_TESTS_EXISTS}"
      echo -e "${PURPLE_BLUE}  + ${RESET}"
      echo -e "${PURPLE_BLUE}  + ${RESET}"
    }
    fi
...
${ALL_SPECSRB}"
    ...
    if [[ -n "${INTEGRATION_TESTS_EXISTS}" ]] ; then
    {
      if [[ -n "${ALL_TESTSRB}" ]] ; then
      {
          ...
          if [[ "${OBSERVE}" == 'yes' ]] ; then
          {
            # RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec  spring server&
            wait
            RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec  spring status
            ##### REAPEAT START
            echo -e "${PURPLE_BLUE}  + "
            echo -e "${PURPLE_BLUE}  + ${CYAN}OBSERVING NOW: ${YELLOW220} INTEGRATION"
            echo -e "${PURPLE_BLUE}  + "

            echo -e "${PURPLE_BLUE}  + ${CYAN}nodemon --watch ${ALL_TESTSRB} --exec RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec ruby -I\"lib:test\" -I${RAKE_EXECUTABLE} ${YELLOW220}${ALL_TESTSRB}${RED}"
            echo -e "${PURPLE_BLUE}  + ${RESET}"
            eval "nodemon --watch ${ALL_TESTSRB} --exec  RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec ruby -I\"lib:test\" -I${RAKE_EXECUTABLE} " ${ALL_TESTSRB}
            #ruby -I"lib:test" -I"/home/vagrant/.rvm/gems/ruby-2.2.5/gems/rake-10.5.0/lib" "/home/vagrant/.rvm/gems/ruby-2.2.5/gems/rake-10.5.0/lib/rake/rake_test_loader.rb" "test/models/insurance_test.rb" "test/workers/twilio_cleaner_worker_test.rb" "test/controllers/account/doctors_controller_test.rb" "test/controllers/doctors/specialties_controller_test.rb" "test/workers/dtms_cleaner_worker_test.rb" "test/controllers/accounts_controller_test.rb" "test/integration/inquiry_plugin_integration_test.rb" "test/controllers/inquiries/confirmations_controller_test.rb" "test/integration/practice_integration_test.rb" "test/services/unprocessed_bookings_test.rb" "test/mailers/user_mailer_test.rb" "test/validators/partner_token_validator_test.rb" "test/models/timeslot_test.rb" "test/models/account_test.rb" "test/models/booking_test.rb" "test/integration/patient_flows_test.rb" "test/controllers/account_backend_controller_test.rb" "test/lib/tasks/unprocessed_bookings_reminders_test.rb" "test/models/inquiry_test.rb" "test/models/partner_test.rb" "test/mailers/smser_test.rb" "test/controllers/directory_controller_test.rb" "test/controllers/account/calendars_controller_test.rb" "test/models/patient_test.rb" "test/integration/review_integration_test.rb" "services/place_service/tests/address_serializer_test.rb"
            echo -e "${PURPLE_BLUE}  + ${RESET}"
            echo -e "${PURPLE_BLUE}  + ${RESET}"
          }
          else
          {
            ...
            echo -e "${PURPLE_BLUE}  + ${CYAN}RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec ruby -I\"lib:test\" -I${RAKE_EXECUTABLE} ${YELLOW220}${ALL_TESTSRB}${RED}"
            echo -e "${PURPLE_BLUE}  + ${RESET}"
            eval "RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true bundle exec ruby -I\"lib:test\" -I${RAKE_EXECUTABLE} " ${ALL_TESTSRB}
            #ruby -I"lib:test" -I"/home/vagrant/.rvm/gems/ruby-2.2.5/gems/rake-10.5.0/lib" "/home/vagrant/.rvm/gems/ruby-2.2.5/gems/rake-10.5.0/lib/rake/rake_test_loader.rb" "test/models/insurance_test.rb" "test/workers/twilio_cleaner_worker_test.rb" "test/controllers/account/doctors_controller_test.rb" "test/controllers/doctors/specialties_controller_test.rb" "test/workers/dtms_cleaner_worker_test.rb" "test/controllers/accounts_controller_test.rb" "test/integration/inquiry_plugin_integration_test.rb" "test/controllers/inquiries/confirmations_controller_test.rb" "test/integration/practice_integration_test.rb" "test/services/unprocessed_bookings_test.rb" "test/mailers/user_mailer_test.rb" "test/validators/partner_token_validator_test.rb" "test/models/timeslot_test.rb" "test/models/account_test.rb" "test/models/booking_test.rb" "test/integration/patient_flows_test.rb" "test/controllers/account_backend_controller_test.rb" "test/lib/tasks/unprocessed_bookings_reminders_test.rb" "test/models/inquiry_test.rb" "test/models/partner_test.rb" "test/mailers/smser_test.rb" "test/controllers/directory_controller_test.rb" "test/controllers/account/calendars_controller_test.rb" "test/models/patient_test.rb" "test/integration/review_integration_test.rb" "services/place_service/tests/address_serializer_test.rb"
            echo -e "${PURPLE_BLUE}  + ${RESET}"
            echo -e "${PURPLE_BLUE}  + ${RESET}"
          }
        ...
        if command -v rspec >/dev/null 2>&1; then
        {
          ...
          if [[ "${OBSERVE}" == 'yes' ]] ; then
          {
            ...
            if [ ${_specs_count} -eq 1 ] ; then
            {
              ...
              echo -e "${PURPLE_BLUE}  + "
              echo -e "${PURPLE_BLUE}  + ${CYAN}RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true CI_RSPEC${RED}=true ${CYAN}nodemon --watch ${ALL_SPECSRB} --exec bundle exec rspec ${ALL_SPECSRB} ${RED}--format ${YELLOW220}progress ${RED}--format  ${YELLOW220}RspecJunitFormatter ${RED}--out ${YELLOW220}rspec.xml${RESET}"
              echo -e "${PURPLE_BLUE}  + ${RESET}"
            ...
            else
            {
              ...
              echo -e "${PURPLE_BLUE}  + "
              echo -e "${PURPLE_BLUE}  + ${CYAN}RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true  CI_RSPEC${RED}=true ${CYAN}nodemon ${_observing_files} --watch ${ALL_SPECSRB} --exec bundle exec rspec ${ALL_SPECSRB} ${RED}--format ${YELLOW220}progress ${RED}--format  ${YELLOW220}RspecJunitFormatter ${RED}--out ${YELLOW220}rspec.xml${RESET}"
              echo -e "${PURPLE_BLUE}  + ${RESET}"
          ...
          else
          {
            ...
            echo -e "${PURPLE_BLUE}  + ${CYAN}RACK_ENV=test RAILS_ENV=test NODE_ENV=test COVERAGE=true CI_RSPEC${RED}=true ${CYAN}bundle exec rspec ${ALL_SPECSRB} ${RED}--format ${YELLOW220}progress ${RED}--format  ${YELLOW220}RspecJunitFormatter ${RED}--out ${YELLOW220}rspec.xml${RESET}"
